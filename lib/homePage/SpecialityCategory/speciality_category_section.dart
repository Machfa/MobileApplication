                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            top: (5 / 926) * MediaQuery.of(context).size.height,
                            bottom:
                                (7 / 926) * MediaQuery.of(context).size.height),
                        child: Image(
                          image: AssetImage(speciality[index][0]),
                          height:
                              (66 / 926) * MediaQuery.of(context).size.height,
                          width: (66 / 428) * MediaQuery.of(context).size.width,
                        ),
                      ),
                      Text(
                        speciality[index][1],
                        style: GoogleFonts.inter(
                          textStyle: TextStyle(
                            ...
                            fontWeight: FontWeight.bold,
                            fontSize:
                                (13 / 926) * MediaQuery.of(context).size.height,
                            letterSpacing: -0.2,
                          ),
                        ),
                      ),
