  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      padding: EdgeInsets.symmetric(
          horizontal: (24 / 428) * MediaQuery.of(context).size.width),
      shrinkWrap: true, // Added shrinkWrap to avoid unbounded height
              ...
              children: [
                  ...
                  child: SizedBox(
                    ...
                    child: CircleAvatarWithStatus(
                      statusColor: doctors[index][2] == true.toString()
                          ...
                          : Colors.transparent,
                      size: (100 / 428) * MediaQuery.of(context).size.width,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.inter(
                        textStyle: TextStyle(
                          ...
                          fontSize:
                              (18 / 926) * MediaQuery.of(context).size.height,
                        ),
                      ),
                    ),
                    const SizedBox(
                    ...
                    Row(
                      children: [
                        Image.asset('lib/icons/availableDoctors/star.png'),
                        const SizedBox(
                          width: 5,
                        ),
                        Text(
                    ...
                    Row(
                      children: [
                        Image.asset('lib/icons/availableDoctors/running.png'),
                        const SizedBox(
                          width: 5,
                        ),
                        Text(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.inter(
                              textStyle: TextStyle(
                                color: const Color.fromRGBO(255, 0, 0, 0.87),
                                fontWeight: FontWeight.bold,
                                fontSize: (18 / 926) *
                                    MediaQuery.of(context).size.height,
                              ),
